...
@app.get('/books/{book_id}/chapters', responses={404: {'description': 'Книга с указанным ID не найдена'}})
...
@app.get('/books/{book_id}/chapters/{chapter_id}', responses={404: {'description': 'Книга с указанным ID не найдена'}})
